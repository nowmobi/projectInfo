...
import { Category_URL, getImgUrl, getArticles } from './BaseURL.js';
class CategoryPage {
    constructor() {
        this.articles = [];
        this.categories = [];
    ...
    async loadData() {
        try {
            ...
            if (Array.isArray(articles) && articles.length > 0) {
                ...
                if (cachedData) {
                    try {
                        ...
                        const processed = this.processData([{...data[0]}, ...articles], categoryOrder);
            ...
            console.error('Error loading articles from shared cache:', error);
        }
