...
const PATHS = {
  pagesDir: '/pages/',
  detailPage: 'de.html',
  detailPageFromPages: '../de.html',
  indexPage: 'index.html',
  indexPageFromPages: '../index.html',
  categoryPage: 'pages/ca.html'
};
...
const Utils = {
  ...
  createArticleCard(article, decodeUnicode = null) {
    ...
    const detailUrl = isInPagesDir ? `../de.html?id=${articleId}` : `de.html?id=${articleId}`;
    ...
    return `
      <div class="article-card" data-id="${articleId}">
        ...
        <a href="${detailUrl}" class="read-now-btn">Read Now</a>
      </div>
    `;
  },
