export const Category_URL = "https://api.frontage.fun/api/compatible/finance_info/dynamic-db.json?num=40&thirdCategoryIds=2248,2249,2251,2254,2255,2231,2230&created_at=2026-8-17";
export const Detail_BASE_URL = "https://api.frontage.fun/api/compatible";
