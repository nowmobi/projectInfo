            ...
            <div class="home_article-item">
              <a class="article-card" href="${detailHref}">
                <div class="article-content">
                  <h3 class="article-title">${Utils.decodeUnicode(articleTitle)}</h3>
                  <div class="article-meta">
                ...
                <div class="article-image">
                  <img src="${articleImage}" alt="${articleTitle}" onerror="this.src='https://via.placeholder.com/300x200?text=Image+Not+Found'">
                </div>
              </a>
            </div>
          `;
