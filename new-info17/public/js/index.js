  ...
  renderCategoryBar() {
    ...
    categoryBar.innerHTML = this.categories
      .map((category, index) => {
        ...
        if (index === 1) {
          iconSrc = 'public/images/law.svg';
        } 
        
        else if (index === 2) {
          iconSrc = 'public/images/investing.svg';
        } 
         else if (index === 3) {
          iconSrc = 'public/images/finance.svg';
        }  else if (index === 4) {
          iconSrc = 'public/images/lawyer.svg';
        }  else if (index === 5) {
          iconSrc = 'public/images/loans_mortgages.svg';
        }  else if (index === 6) {
          iconSrc = 'public/images/real_eatate.svg';
        }  else if (index === 7) {
          iconSrc = 'public/images/car.svg';
        } 
        
        else {
          iconSrc = category.icon || this.getCategoryIcon(category.id, category.name);
        }
