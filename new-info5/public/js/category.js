...
import { Category_URL, formatTime } from "./BaseURL.js";
  ...
  async loadData() {
    ...
    while (retryCount < maxRetries) {
      try {
        ...
        window.healthNewsApp.articles = articles;
        window.healthNewsApp.categories = this.categories;
        try {
        ...
        (article) => `
            <div class="article-card" data-id="${article.id}">
                <div class="article-image">
                    <img src="${this.escapeHtmlAttr(this.getArticleImagePath(article))}" alt="${this.escapeHtmlAttr(article.title || '')}" onerror="this.onerror=null; this.src='data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20width=%27300%27%20height=%27200%27%3E%3Crect%20fill=%27%23f0f0f0%27%20width=%27300%27%20height=%27200%27/%3E%3Ctext%20fill=%27%23999%27%20x=%2750%25%27%20y=%2750%25%27%20text-anchor=%27middle%27%20dy=%27.3em%27%20font-family=%27Arial%27%20font-size=%2714%27%3EImage%20Not%20Found%3C/text%3E%3C/svg%3E';">
                </div>
  ...
  bindArticleEvents() {
    ...
    articleCards.forEach((card) => {
      card.addEventListener("click", (e) => {
        ...
        window.healthNewsApp.selectedArticle = this.articles.find(a => a.id === articleId);
