...
const CATEGORY_ICON_MAP = {
  ...
  finance: 'public/images/finance.png',
  investing: 'public/images/investing.png',
  invest: 'public/images/investing.png',
  loans: 'public/images/loans_mortgages.png',
  'loans-mortgages': 'public/images/loans_mortgages.png',
  mortgage: 'public/images/loans_mortgages.png',
  law: 'public/images/law.png',
  lawyer: 'public/images/lawyer.png',
  legal: 'public/images/law.png',
  car: 'public/images/car.png',
  auto: 'public/images/car.png',
  'real-eatate': 'public/images/real_eatate.png',
  'real-estate': 'public/images/real_eatate.png',
  house: 'public/images/real_eatate.png'
};
...
class Website {
  ...
  async loadData() {
    try {
      ...
      this.categoryOrder = getCategoryOrder(data);
    ...
    this.categories = [
      ...
      ...orderedCategories.map(type => {
        ...
        return {
          id: normalizedId,
          name: type,
          icon: this.getCategoryIcon(normalizedId, type)
        };
      })
    ];
  ...
  renderCategoryBar() {
    ...
    categoryBar.innerHTML = this.categories
      .map(category => {
        ...
        const iconSrc = window.Utils.escapeHtml(
          category.icon || this.getCategoryIcon(category.id, category.name)
        );
