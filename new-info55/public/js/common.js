...
export async function renderDropdownCategories(categoryPath = getCategoryPagePath()) {
...
export function bindDropdownNavigation() {
  ...
  dropdownItemsContainer.addEventListener("click", (e) => {
    ...
    if (item.dataset.category) {
      if (document.body.classList.contains("home-page") || isCategoryPage) {
        return;
      }
    }
...
async function autoDetectAndInitSimplePages() {
  ...
  if (isAboutPage || isPrivacyPage || isTermsPage || isContactPage) {
