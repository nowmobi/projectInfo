...
class CategoryPage {
  ...
  getCategoryIcon(categoryName) {
    ...
    if (CATEGORY_ICON_MAP[normalizedId]) {
      return CATEGORY_ICON_MAP[normalizedId];
    }
  ...
  assignCategoryIcons() {
    ...
    this.categories.forEach((cat, idx) => {
      ...
      const mapped = CATEGORY_ICON_MAP[normalizedId];
      if (mapped) {
        this.categoryIcons[normalizedId] = mapped;
        return;
      }
