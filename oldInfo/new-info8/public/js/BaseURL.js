// 基础URL配置
const REMOTE_DATA_BASE_URL = "https://alldata-75c.pages.dev/technology";
const REMOTE_DB_URL = `${REMOTE_DATA_BASE_URL}/db.json`;
const IMG_BASE_URL = "https://alldata-75c.pages.dev/technology";
// inpublic.js 使用的配置
const DATA_BASE_URL = "https://alldata-75c.pages.dev/technology";
const DataConfig = {
